...
<body class="bg-bg-dark-primary text-body-cyan-40 flex p-0 m-0 min-h-screen flex-col">
  <nav
    ...
    <div class="flex gap-3 h-8 ml-auto">
      <a class="text-body-cyan-40 leading-relaxed hover:text-primary-bright" href="/LogIn">LogIn</a>
      <a class="text-body-cyan-40 leading-relaxed hover:text-primary-bright" href="/SignUp">SignUp</a>
    </div>
  </nav>
  <main>
    <div
      class="text-primary-bright p-6 flex gap-6 justify-start flex-col items-center absolute top-1/5 left-1/2 -translate-x-1/2 sm:w-[40vw] min-h-[50vh] shadow-[0_0_30px_1px_var(--color-body-cyan-40)] border border-body-cyan bg-bg-card rounded-lg backdrop-blur">
