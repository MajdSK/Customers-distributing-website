  ...
  <div class="p-6">
    ...
    <div class="grid grid-cols-1 gap-4">
      @forelse($users as $user)
        <div
          class="flex items-center justify-between p-4 rounded-lg border bg-bg-card text-body-cyan border-body-cyan-40">
          <div class="flex-1">
          ...
          <div class="flex gap-3 ml-4">
            <form action="/Admin/Users/Destroy/{{ $user->id }}" method="POST">
              @csrf
              @method("DELETE")
              <button type="submit" class="px-3 py-2 rounded-full font-semibold bg-accent-rose text-white">Remove</button>
            </form>
            ...
            <form action="/Admin/Users/Verify/{{ $user->id }}" method="POST">
              ...
              @method("PATCH")
              <button type="submit"
                class="px-3 py-2 rounded-full font-semibold bg-body-cyan text-bg-dark-primary">Verify</button>
            </form>
