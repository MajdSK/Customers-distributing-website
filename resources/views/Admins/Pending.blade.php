  ...
  <div class="p-6">
    ...
    <div class="grid grid-cols-1 gap-6">
      @forelse($customers->where('visited', false) as $customer)
        <div class="p-4 rounded-lg border bg-bg-card border-body-cyan-40 text-body-cyan flex items-start justify-start">
          <div>
          ...
          <div class="mt-3 flex gap-3 flex-col justify-center ml-auto items-center">
            <form action="/Customer/MarkVisited/{{ $customer->id }}" method="POST">
              @csrf
              @method("PATCH")
